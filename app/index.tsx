...
export default function Index() {
	const [url, setUrl] = useState("2chan.net"); // URL state
	const [prompt, setPrompt] = useState("다음과 같은 텍스트 리스트를 한국어로 번역하세요. # 어떤 추가 문구 없이 리스트만을 출력하세요. 개행문자 ||는 리스트의 형식에 포함됩니다. 절대로 리스트의 형식이 손상되거나 숫자가 변해서는 안됩니다!!!");
